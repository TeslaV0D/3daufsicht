...
## Stand 8: Bibliotheks-Gruppen, Hover-Stabilitaet, Shortcuts-UI
...
- **Hover-Animation / Highlight**: Debounce beim Pointer-Leave (50 ms), damit Wechsel zwischen Submeshes nicht `hoveredId` staendig leert und neu setzt.
