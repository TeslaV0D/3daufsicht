...
### Fog / Nebel (Kurzüberblick)

- Toggle **Fog aktivieren**; bei Linear: **Start** (0–100 m) und **Ende** (5–500 m); bei Exponentiell: **Dichte** per Schieberegler.
- Farbe frei wählbar (z. B. an Hintergrund angepasst).
